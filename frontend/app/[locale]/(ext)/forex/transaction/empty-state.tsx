...
export default function TransactionsEmptyState() {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200/50 dark:border-zinc-700/50 shadow-xl p-12 text-center">
      <div
        className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-teal-500/10 dark:bg-teal-500/20 mb-6`}
      >
        <Receipt
      ...
      <p className="text-zinc-600 dark:text-zinc-400 max-w-md mx-auto mb-8">
        {tExtForex("your_transaction_history_will_appear_here")}
      </p>
    </div>
  );
}
