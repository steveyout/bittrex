...
export default function DashboardErrorState({ onRetry, error }: ErrorStateProps) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-red-200 dark:border-red-800 shadow-xl p-12 text-center">
      ...
      <h3 className="text-2xl font-bold text-zinc-900 dark:text-white mb-3">
        {t("error_loading_portfolio")}
      </h3>
      <p className="text-zinc-600 dark:text-zinc-400 max-w-md mx-auto mb-8">
        {error || "There was an error loading your portfolio data. Please try again."}
      </p>
      {onRetry && (
        <Button
          onClick={onRetry}
